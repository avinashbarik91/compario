...
{
	echo json_encode(array("output" => render_players_comparison($_POST['player_1_link'], $_POST['player_1_name'], $_POST['player_2_link'], $_POST['player_2_name'], $_POST['match_type'], $_POST['stat_type'])));
	exit();
}
