			...
			<div class='container px-5 additional-wrapper'>
				<div class='row'>
					<div class='offset-md-2 col-md-8 p-5'>
						<h1 class='mb-4'>That's Out!</h1>
						<p>Error 404. Page not found!</p>
						<p>Hey there! The page you are looking for is not here. This could be a result of broken links or wrong URLs.</p>
						<a href='/'><p>Click here to go back to Home Page</p></a>
					</div>
				</div>
			</div>
