...
<html lang="en">
	<head>
		...
		<title>Features | Compario - Simple head-to-head comparison for cricket players</title>
		<meta charset="UTF-8">
		<meta http-equip="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<meta name="description" content="Simple head-to-head comparison for cricket players">
		<meta http-equiv="x-ua-compatible" content="ie-edge">
		<meta property='og:title' content='Compario Features'/>		
		<meta property='og:description' content='Features | Compario - Simple head-to-head comparison for cricket players. Compare cricket players'/>
	...
	<body>
			...
			<div class='player-comp-intro container additional-wrapper'>
				<div class='row'>				
					<div class='offset-md-2 col-md-8 p-2'>
						<h1 class='mb-4'><i class="about-page-icon fas fa-info-circle"></i>Features</h1>
						<h3>The only cricket player comparison tool you will ever need</h3>
